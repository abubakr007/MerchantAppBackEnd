...
{
    public class CreateOfflineGeneralQueuesCommandHandler : ICommandHandler<CreateOfflineGeneralQueuesCommand>
    {
        ...
        public CreateOfflineGeneralQueuesCommandHandler(
        ...
        public void Execute(CreateOfflineGeneralQueuesCommand command)
        {
